...
#chrm = 'X'
sample_size = [200, 200] # I am hard coding this, but could be obtained from ms command line -I flag



n_sites = 100 * 1000

output_dxy_counts = open('simple_sim_dxy.csv','w')
output_pi_pops = open('simple_sim_pi.csv','w')
...
## Calculate dxy
        pi_sum = 0
        with open("2Pop_Results.txt") as sim_results:
