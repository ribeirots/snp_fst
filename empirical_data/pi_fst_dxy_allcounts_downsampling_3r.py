...
output_pi_dxy = open('delete_empirical_pi_dxy_downsampled.csv','w')
...
for arm in chrm:
    for p1 in range(0,len(pops)):
        ...
        for p2 in range(p1+1,len(pops)):
            ...
            outfile_snp_fst = open('empirical_snp_fst_'+pops[p1]+'_'+pops[p2]+'_NoInv_Chr'+arm+'downsampled2.txt','w')
