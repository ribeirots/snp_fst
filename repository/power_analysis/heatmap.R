...
heatmap_power_gg <- function(dset, varX, varY, varFill, varTitle){
  gg_inc_fst_ss <- ggplot(dset, aes_string(varX, varY, fill=varFill)) + geom_tile() + scale_fill_viridis_c(option="B", direction=-1) + 
    theme_light() + ggtitle(varTitle) + geom_text(aes_string(label=varFill))
  return(gg_inc_fst_ss)
}
...
plot_title = 'SNP FST - Incomplete Sweep - HN (s=0.01)'
gg_inc_fst_ss <- heatmap_power_gg(inc_fst_ss, 'init_Freq', 'final_Freq', 'power', plot_title)
gg_inc_fst_ss
...
plot_title = 'Window FST - Incomplete Sweep - HN (s=0.01)'
gg_inc_fst_ss_win <- heatmap_power_gg(inc_fst_ss_win, 'init_Freq', 'final_Freq', 'power', plot_title)
gg_inc_fst_ss_win
...
gg_inc_chi_ss <- heatmap_power_gg(inc_chi_ss, 'init_Freq', 'final_Freq', 'power', plot_title)
gg_inc_chi_ss
...
plot_title = 'SNP FST - Incomplete Sweep - HN (s=0.001)'
gg_inc_fst_ws <- heatmap_power_gg(inc_fst_ws, 'init_Freq', 'final_Freq', 'power', plot_title)
gg_inc_fst_ws
...
plot_title = 'Window FST - Incomplete Sweep - HN (s=0.001)'
gg_inc_fst_ws_win <- heatmap_power_gg(inc_fst_ws_win, 'init_Freq', 'final_Freq', 'power', plot_title)
gg_inc_fst_ws_win
...
plot_title = 'CHI - Incomplete Sweep - HN (s=0.001)'
gg_inc_chi_ws <- heatmap_power_gg(inc_chi_ws, 'init_Freq', 'final_Freq', 'power', plot_title)
gg_inc_chi_ws
...
plot_title = 'SNP FST - Incomplete Sweep - LN (s=0.01)'
gg_inc_fst_ln <- heatmap_power_gg(inc_fst_ln, 'init_Freq', 'final_Freq', 'power', plot_title)
gg_inc_fst_ln
...
plot_title = 'Window FST - Incomplete Sweep - LN (s=0.01)'
gg_inc_fst_ln_win <- heatmap_power_gg(inc_fst_ln_win, 'init_Freq', 'final_Freq', 'power', plot_title)
gg_inc_fst_ln_win
...
plot_title = 'CHI - Incomplete Sweep - LN (s=0.01)'
gg_inc_chi_ln <- heatmap_power_gg(inc_chi_ln, 'init_Freq', 'final_Freq', 'power', plot_title)
gg_inc_chi_ln
...
plot_title = 'SNP FST - Migration - HN (s=0.01)'
gg_migr_fst_ss <- heatmap_power_gg(migr_fst_ss, 'MigrationRate', 'SplitTime', 'power', plot_title)
gg_migr_fst_ss
...
migr_fst_ss$power <- as.numeric(migr_fst_ss$power)
migr_fst_ss$MigrationRate <- as.numeric(migr_fst_ss$MigrationRate)
plot_title = 'Window FST - Migration - HN (s=0.01)'
gg_migr_fst_ss <- heatmap_power_gg(migr_fst_ss, 'MigrationRate', 'SplitTime', 'power', plot_title)
gg_migr_fst_ss
...
plot_title = 'CHI - Migration - HN (s=0.01)'
gg_migr_chi_ss <- heatmap_power_gg(migr_chi_ss, 'MigrationRate', 'SplitTime', 'power', plot_title)
gg_migr_chi_ss
...
plot_title = 'SNP FST - Migration - HN (s=0.001)'
gg_migr_fst_ws <- heatmap_power_gg(migr_fst_ws, 'MigrationRate', 'SplitTime', 'power', plot_title)
gg_migr_fst_ws
...
plot_title = 'Window FST - Migration - HN (s=0.001)'
gg_migr_fst_ws <- heatmap_power_gg(migr_fst_ws, 'MigrationRate', 'SplitTime', 'power', plot_title)
gg_migr_fst_ws
...
plot_title = 'CHI - Migration - HN (s=0.001)'
gg_migr_chi_ws <- heatmap_power_gg(migr_chi_ws, 'MigrationRate', 'SplitTime', 'power', plot_title)
gg_migr_chi_ws
...
plot_title = 'SNP FST - Migration - LN (s=0.01)'
gg_migr_fst_ln <- heatmap_power_gg(migr_fst_ln, 'MigrationRate', 'SplitTime', 'power', plot_title)
gg_migr_fst_ln
...
plot_title = 'Window FST - Migration - LN (s=0.01)'
gg_migr_fst_ln <- heatmap_power_gg(migr_fst_ln, 'MigrationRate', 'SplitTime', 'power', plot_title)
gg_migr_fst_ln
...
plot_title = 'CHI - Migration - LN (s=0.01)'
gg_migr_chi_ln <- heatmap_power_gg(migr_chi_ln, 'MigrationRate', 'SplitTime', 'power', plot_title)
gg_migr_chi_ln
